"""Streamable HTTP Request implementation.

This module provides streaming request handling for efficient processing
of large request bodies without loading everything into memory.
"""
