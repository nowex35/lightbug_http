"""Streamable HTTP Response implementation.

This module provides streaming response handling for efficient transmission
of large response bodies using chunked transfer encoding and SSE.
"""
