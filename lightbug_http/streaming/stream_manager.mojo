"""Stream and session management for streaming HTTP connections.

This module provides infrastructure for managing active streaming connections,
tracking sessions, and handling cleanup of long-lived HTTP streams.
"""
